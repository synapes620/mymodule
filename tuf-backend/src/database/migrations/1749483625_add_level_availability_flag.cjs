...
module.exports = {
  async up(queryInterface, Sequelize) {
    // Add isExternallyAvailable column
    await queryInterface.addColumn('levels', 'isExternallyAvailable', {
      type: Sequelize.BOOLEAN,
      allowNull: false,
      defaultValue: false
    });

    // Update pass summary view with external availability check
  ...
  async down(queryInterface, Sequelize) {
    ...
    // Remove isExternallyAvailable column
    await queryInterface.removeColumn('levels', 'isExternallyAvailable');
  }
}; 